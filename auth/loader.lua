local LAL = (loadstring or load)(game:HttpGet("https://github.com/Hosvile/Luarion/releases/latest/download/release.lua", true), "VASL")(...)(...)
...
if Status then
	repeat
		task.wait()
	until not (not (#StatusObject == #StatusObject))

	warn("UNAUTHORIZED & COMPROMISED")
end
